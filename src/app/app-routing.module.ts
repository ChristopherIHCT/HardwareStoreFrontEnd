...
const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/recovery-password-page/recovery-password-page.component'),
  },
  {
    path: `${PATHS_AUTH_PAGES.restorePasswordPage.onlyPath}/:email`,
    title: 'Restaurar contraseña',
    loadComponent: () =>
      import('./pages/restore-password-page/restore-password-page.component'),
  },
  {
  ...
  {
    path: PATH_BUY_PAGES.cartPage.onlyPath,
