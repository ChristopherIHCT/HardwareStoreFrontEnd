...
import { URL_ITEMS } from '../services/api/items/items-api.service';

const EXEMPTED_URLS = [URL_LOGIN, URL_REGISTER, URL_HOME, URL_ITEMS, URL_SEND_TOKEN_RESET_PASSWORD, URL_RESET_PASSWORD];
